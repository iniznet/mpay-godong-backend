    ...
    return (<div className="grid p-fluid input-demo">
            ...
            <div className="col-12 md:col-6">
                <div className="card">
                    ...
                    <div className="grid">
                        ...
                        <div className="col-12 md:col-4">
                            <div className="field-checkbox">
                                <Checkbox inputId="checkOption2" name="option" value="Los Angeles" checked={checkboxValue.indexOf("Los Angeles") !==
            -1} onChange={onCheckboxChange}/>
                ...
                <div className="card">
                    ...
                    <h5>MultiSelect</h5>
                    <MultiSelect value={multiselectValue} onChange={(e) => setMultiselectValue(e.value)} options={multiselectValues} itemTemplate={itemTemplate} optionLabel="name" placeholder="Select Countries" filter className="multiselect-custom" display="chip"/>
                </div>
