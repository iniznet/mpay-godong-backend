...
const DepositCrud = () => {
    ...
    const editDeposit = (deposit) => {
        ...
        if (deposit.user_id) {
            setUserBalances(balances.filter(balance => balance.user.id === deposit.user_id));
        }
                ...
                <div className="card">
                    ...
                    <Dialog visible={depositDialog} style={{ width: '450px' }} header="Deposit Details" modal className="p-fluid" footer={depositDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            ...
                            <Dropdown
                                ...
                                className={classNames({ 'p-invalid': submitted && !deposit.user_id })}
                            />
                            {submitted && !deposit.user_id && <small className="p-invalid">Kustomer wajib diisi.</small>}
                        </div>
                        <div className="field">
                    ...
                    <Dialog visible={deleteDepositDialog} style={{ width: '450px' }} header="Konfirmasi" modal footer={deleteDepositDialogFooter} onHide={hideDeleteDepositDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {deposit && (
                                <span>
                                    Apakah Anda yakin ingin menghapus setoran <b>{deposit.user?.name}</b> dengan kode referensi <b>{deposit.reference}</b>?
                                </span>
                            )}
                        </div>
                    </Dialog>
